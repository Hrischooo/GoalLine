    ...
    <section className="team-block">
      ...
      <div className="team-rating-panel">
        <div className="team-rating-panel__hero">
          ...
          <p>
            {formatTextValue(team?.displayName)} projects best in a {formatTextValue(bestXI?.formation || team?.detectedFormation, 'N/A')} with{' '}
            {Math.round((bestXI?.formationConfidence || team?.formationConfidence || 0) * 100)}% formation confidence.
          </p>
        </div>
        ...
        <div className="team-rating-panel__grid">
          ...
          <RatingTile label="Formation Fit" value={bestXI?.formationFitScore || team?.formationFitScore} />
